...
@section('content')
    <div class="flex h-full w-full flex-col font-dos">
        <div class="max-w-xl mx-auto | elements-breath-10 px-8 xl:px-24 pb-24 xl:py-6">
            <h2 class="retro-title-2">C:\Editor></h2>
            <p>
            ...
            <img class="mx-auto text-center" src="/media/uses/desk.jpg" alt="My desk.">

            <h5 class="retro-title-4">C:\Desktop Setup\Output></h5>
            ...
            <h5 class="retro-title-4">C:\Desktop Setup\Input></h5>
