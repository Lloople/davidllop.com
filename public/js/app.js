...
document.querySelector('#simon').addEventListener('click', function () {
...
document.querySelector('.sorcerers').addEventListener('click', function () {
    ...
    if (audio === null) {
        ...
        document.querySelector('.sorcerers').addEventListener('mouseover', function () {
            audio.volume = 0.7;
        });

        // Mute the music when the mouse leaves the Sorcerers area
        document.querySelector('.sorcerers').addEventListener('mouseleave', function (e) {
            audio.volume = 0.0;
        });
    }
});
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    ...
                    case 2:
                        ...
                        bubbles = Array.from(conversations[conversation - 1].querySelectorAll('div'));
                        _context2.t0 = _regenerator2.default.keys(bubbles);
                    ...
                    case 5:
                        ...
                        _context2.next = 11;
                        return wait(bubble.dataset.wait);
